...
{
	void SaveGame(ServicesContext serviceContext, IGameRepository gameRepository);
	void LoadGame(ServicesContext serviceContext, IGameRepository gameRepository);
}

public abstract class SaveLoader<TService, TData> : ISaveLoader
{
	public void SaveGame(ServicesContext serviceContext, IGameRepository gameRepository)
	{
	...
	public void LoadGame(ServicesContext serviceContext, IGameRepository gameRepository)
	{
		var service = serviceContext.GetService<TService>();
