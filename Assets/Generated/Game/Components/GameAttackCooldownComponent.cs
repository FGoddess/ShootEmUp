...
public partial class GameEntity {
    ...
    public Components.AttackCooldownComponent attackCooldown { get { return (Components.AttackCooldownComponent)GetComponent(GameComponentsLookup.AttackCooldown); } }
    public bool hasAttackCooldown { get { return HasComponent(GameComponentsLookup.AttackCooldown); } }

    public void AddAttackCooldown(float newCooldownDuration, float newLastAttackTime) {
        var index = GameComponentsLookup.AttackCooldown;
        var component = (Components.AttackCooldownComponent)CreateComponent(index, typeof(Components.AttackCooldownComponent));
        component.CooldownDuration = newCooldownDuration;
        component.LastAttackTime = newLastAttackTime;
        AddComponent(index, component);
    }

    public void ReplaceAttackCooldown(float newCooldownDuration, float newLastAttackTime) {
        var index = GameComponentsLookup.AttackCooldown;
        var component = (Components.AttackCooldownComponent)CreateComponent(index, typeof(Components.AttackCooldownComponent));
        component.CooldownDuration = newCooldownDuration;
        component.LastAttackTime = newLastAttackTime;
